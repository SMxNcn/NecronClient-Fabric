...
// From https://github.com/skies-starred/OdinClient/blob/master/src/main/kotlin/starred/skies/odin/features/impl/cheats/AutoExperiments.kt
object AutoExperiments: Module (
    ...
    init {
        ...
        on<TickEvent.End> {
            ...
            if (now - lastClickTime < delay()) return@on
    ...
    private fun delay(): Long = (delay + (0..50).random()).toLong()
