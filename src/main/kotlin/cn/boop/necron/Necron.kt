...
object Necron : ClientModInitializer {
    ...
    override fun onInitializeClient() {
        ClientCommandRegistrationCallback.EVENT.register { dispatcher, _ ->
            arrayOf(autoSellCommand, devCommand, necronChatCommand, necronCommand, nwpCommand).forEach { commodore -> commodore.register(dispatcher) }
        }
        ...
        ModuleManager.registerModules(config,
            ...
            RngMeterHUD, TitleManager
        )

        CustomEventDispatcher.postFabricEvents()
    }
}
